      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          <form action={formAction} className="space-y-6">
            ...
            <div>
              <Label htmlFor="profileImageUrl" className="text-sm font-medium">Profile Image URL (Full URL or relative path e.g., /my-image.png)</Label>
              <Input
                ...
                placeholder="https://example.com/image.jpg or /avatar.png"
